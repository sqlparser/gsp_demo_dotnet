...
namespace gudusoft.gsqlparser.demos.extractTableColumns
{


    public class extractTableColumns
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Usage: extractTableColumns [/f <path_of_sql_file>] [/d <path_to_directory_includes_sql_files>] [/o <path_to_directory_table_columns_result>] [/t <database type>]");
            ...
            if (sqlFiles != null)
            {
                if (outputDir != null)
                {
                    outputFile = Path.Combine(outputDir.FullName, "tableColumns.txt");
                    errorFile = Path.Combine(outputDir.FullName, "error.txt");
                }
                else
                {
                    outputFile = Path.Combine(".", "tableColumns.txt");
                    errorFile = Path.Combine(".", "error.txt");
                }
            }
            ...
            for (int i = 0; i < files.Count; i++)
            {
                ...
                try
                {
                    ...
                    extractTableColumns relation = new extractTableColumns();
